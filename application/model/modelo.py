...
class Unidades (db.Model):#cria a tabela Unidades
    ...
    endereço= db.Column(db.String(400), unique=True, nullable=False)
    #nullable significa que o campo não pode ser nulo
    proprietario = db.Column(db.String(400), nullable= False)
    def __str__(self):
        return f'{str(self.idunidades)}, {self.unidade_nome}, {self.condominio}, {self.endereço}, {self.proprietario}'
    #retorna em string as informaçoes
    def json(self):
        return{
